...
namespace WinTenDev.ZiziBot.App.Extensions
{
    /// <summary>
    ...
    public static class CommonServiceExtension
    {
        ...
        public static IServiceCollection AddCommandHandlers(this IServiceCollection services)
        {
            ...
            services.AddServicesFrom("WinTenDev.ZiziBot.App.Handlers.Modules", ServiceLifetime.Scoped);
            services.AddServicesFrom("WinTenDev.ZiziBot.App.Handlers.CallbackHandlers", ServiceLifetime.Scoped);
