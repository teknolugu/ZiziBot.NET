...
namespace WinTenDev.ZiziBot.App.Handlers.CallbackHandlers
{
    /// <summary>
    ...
    public class PingCallbackHandler : ICallbackHandler
    {
        ...
        /// <returns></returns>
        public bool Execute(CallbackQuery callbackQuery, Func<CallbackAnswer, Task> onAnswerCallback)
        {
            var callbackParse = callbackQuery.Data.ParseCallback();

            var answerCallback = "Pong!";

            onAnswerCallback(new CallbackAnswer()
            {
        ...
        public async Task<bool> ExecuteAsync(CallbackQuery callbackQuery, Func<CallbackAnswer, Task> onAnswerCallback)
        {
