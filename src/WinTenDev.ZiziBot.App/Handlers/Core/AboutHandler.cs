    ...
    public class AboutHandler : ZiziEventHandler
    {
        ...
        public async Task About()
        {
            ...
            var htmlMsg = new HtmlString()
                ...
                .TextBr($"ℹ️ Bot Telegram resmi berbasis WinTen API. untuk manajemen dan peralatan grup. " +
                        $"Ditulis menggunakan .NET (C#). Untuk detail fitur pada perintah /start.").Br()
                .TextBr("Untuk Bot lebih cepat dan tetap cepat dan terus peningkatan dan keandalan, " +
                        "silakan Donasi untuk biaya Server dan beri saya Kopi.").Br()
